...
namespace CustomerService.Contracts
{
    ...
    public interface ICustomersService
    {
        ...
        Task<int> CreateOrUpdateAsync(long id, int score);
        /// <summary>
        ...
        Task<List<CustomerDto>> GetByRanksAsync(int start, int end);
        /// <summary>
        ...
        /// <returns></returns>
        Task<List<CustomerDto>> GetByIdAndNeighborsAsync(long id, int high, int low);
        ...
        Task<int> GetScoreByIdAsync(long id);
    }
}
